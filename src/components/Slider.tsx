...
export function Slider (){
  return (
    <section className="main w-[100vw] h-[100vh] flex flex-col justify-center items-center">
      <div className="container my-[50px] w-[100vw] h-[90vh] flex flex-row items-center justify-center overflow-hidden">
        <Swiper
