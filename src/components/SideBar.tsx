    ...
    return (
        <main className="main side-bar w-1/3 bg-blacklight p-[32px] rounded-r-[8px]">
            ...
            <div>
                ...
                <div className="sizes w-full bg-white rounded-[8px] px-[24px] py-[18px] flex justify-around items-center">
            ...
            <div>
                ...
                <div className="colors w-full flex justify-between items-center">
