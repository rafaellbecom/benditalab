                ...
                <div className="col-form col-span-2 h-full flex items-center">
                    <div className="w-[80%] mx-auto">
                        ...
                        <div className="formulario flex flex-col justify-center items-center gap-[32px]">
                            <h1 className="font-sans font-bold text-3xl uppercase">Acesse sua conta</h1>
                            ...
                            <form action="" className="w-full flex flex-col justify-center items-center gap-[16px]">
                                ...
                                <button className="w-full px-[32px] py-[16px] bg-black border-2 border-black rounded-[8px] font-sans font-bold text-xl text-white uppercase">Entrar</button>

                                <a href="/signin" className="font-sans text-center text-black text-sm">Esqueci minha senha</a>
                            </form>
                            ...
                            <button className="w-full px-[32px] py-[16px] border-2 border-black rounded-[8px] font-sans font-bold text-xl text-black uppercase">Criar conta</button>
                        </div>
                    </div>
                </div>
